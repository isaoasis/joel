...
app.config['SQLALCHEMY_DATABASE_URI'] = os.getenv('SQLALCHEMY_DATABASE_URI', 'postgres://default:NjXqClpM73Kx@ep-curly-dawn-a4hwnczb-pooler.us-east-1.aws.neon.tech:5432/verceldb?sslmode=require')
